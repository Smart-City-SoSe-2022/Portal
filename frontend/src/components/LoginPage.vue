  ...
  <section class="position-relative py-4 py-xl-5">
    <div class="row mb-5">
      <div class="col-md-8 col-xl-6 text-center mx-auto">
        <h2>Anmeldung</h2>
        <p class="w-lg-50">
          Bitte melden Sie sich an, um den Smart City Service nutzen zu können.
        </p>
      </div>
    </div>
        ...
        <div class="card mb-5">
          <div class="card-body d-flex flex-column align-items-center">
            <div class="bs-icon-xl bs-icon-circle bs-icon-primary bs-icon my-4">
              <svg class="bi bi-person" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                   viewBox="0 0 16 16">
                <path
            ...
            <form class="text-center" method="get" @submit.prevent="login">
...
export default {
  ...
  methods: {
    login() {
      let encodedUserData = btoa(unescape(encodeURIComponent(this.email + ":" + this.password)));

      var myHeaders = new Headers();
      myHeaders.append("Authorization", "Basic " + encodedUserData);
